    ...
    <main>
      ...
      <section className={`section ${styles.features}`} >
        <div className="container">
          <h2 className="section-title" data-aos="fade-up">Why Choose Scoop Investment</h2>
          <p className="section-subtitle" data-aos="fade-up">We specialize in <strong>Mid-Cap, Small-Cap, and Micro-Cap</strong> companies that are typically overlooked but offer strong growth opportunities</p>

          <div className={styles.featureGrid}>
            {WHY_CHOOSE.map((item, index) => (
                <div key={`${item.title}-${index}`} className={styles.featureCard} data-aos="fade-up">
      ...
      <section className={`${styles.aboutPreview}`} data-aos="fade-up">
        <div className="container">
      ...
      <section className={`${styles.aboutPreview}`} >
        <div className="container">
          <div className={styles.aboutGrid}>
            ...
            <div className={styles.aboutImage} data-aos="fade-up">
      ...
      <section className={`section ${styles.ourMission}`} id="disclaimer">
        <div className="container">
          <h2 className="section-title" data-aos="fade-up">Disclaimer</h2>
          <div className={styles.missionContent} data-aos="fade-up">
            <p>
