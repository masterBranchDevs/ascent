...
import { complaintsData, trendMonthlyData, trendYearlyData } from '@/constant/complaintsData'
        ...
        <div className={styles.dropdownWrapper}>
          ...
          <div className={`${styles.dropdownContent} ${openDropdown === 0 ? styles.open : ''}`}>
            <p>
              ...
              clarifications, or shortfalls in delivery standards, either due to inadequacy of
          ...
          <div className={`${styles.dropdownContent} ${openDropdown === 1 ? styles.open : ''}`}>
            <p>
              This charter outlines the responsibilities and obligations of Research Analysts
              towards investors, ensuring transparency and timely disclosures.
            </p>
          </div>
          ...
          <div className={`${styles.dropdownContent} ${openDropdown === 2 ? styles.open : ''}`}>
            <p>
              Investors can register grievances related to research reports or recommendations via
              SEBI's SCORES platform or through direct communication.
            </p>
          </div>
        </div>
